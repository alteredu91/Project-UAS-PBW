...
func main() {
    ...
    adminController := controllers.NewAdminController(db, store)
    ...
    router.HandleFunc("/admin/login", userController.AdminLogin).Methods("POST")
    router.HandleFunc("/admin/user-info", adminController.AdminUserInfo).Methods("GET")
