...
func (uc *UserController) UserPaymentInfo(w http.ResponseWriter, r *http.Request) {
    ...
    json.NewEncoder(w).Encode(map[string]interface{}{"loggedIn": true, "userId": userID, "username": username})
}
